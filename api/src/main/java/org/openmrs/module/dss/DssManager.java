...
public class DssManager {
    ...
    /**
     * Constructor Initializes the patient
     *
    ...
    /**
     * Runs rules of the given type in order of priority until a specified
     * number of non-null results are obtained.
     *
    ...
    /**
     * Sets the maximum number of dss elements that should be populated for a
     * given rule type
     *
     * @param type rule type
    ...
    /**
     * Returns the maximum number of dss elements that should be populated for
     * the given rule type
     *
     * @param type rule type
     * @return int maximum number of dss elements that should be populated for
     * the given rule type
     */
