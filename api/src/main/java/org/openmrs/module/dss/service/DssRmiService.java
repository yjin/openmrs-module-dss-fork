...
public interface DssRmiService extends Remote {
     ...
     *
     * @param username User used to meet the required credentials to pull the
     * information.
     * @param password Password for the username.
     * @param mrn The patient's MRN used to pull information.
     * @return Patient object containing the patient metadata or null if a
     * patient cannot be found for the provided mrn.
     * @throws RemoteException
     */
    public Patient getPatient(String username, String password, String mrn) throws RemoteException;

    /**
     * Retrieve encounter information for a given patient and between the given
     ...
     * @param fromDate Date to qualify the start of the encounters requested.
     * This can be null.
     * @param toDate Date to qualify the end of the encounters requested. This
     * can be null.
     ...
     * @param encounterId The ID of the encounter to execute the rule against.
     * This can be null depending on the rule requirements.
     * @param locationName The name of the clinic. This can be null depending on
     ...
     * information.
     * @param password Password for the username.
     * @param ruleNameLike A like function will be used to get any potential
     * matches to this string. This can be null which will cause the return of
     * all known rules.
    ...
    /**
     * Retrieves the complete physician note based on the encounter for the
     * current day's visit.
     *
     * @param username User used to meet the required credentials to pull the
     * information.
    ...
    /**
     * Utility method available to consumers to test the connection to this
     * service.
     *
