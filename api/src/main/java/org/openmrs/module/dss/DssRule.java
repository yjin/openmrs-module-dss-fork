...
/**
 * Purpose: Provides methods to pass mlm and other rule file metadata into the
 * dss_rule table
 *
 * @author Tammy Dugan
 * @deprecated
...
public interface DssRule {
    ...
    /**
     * Returns the priority value of the rule. This value determines in what
     * order the rules get evaluated.
     *
     ...
     *
     * @return String portion of the rule logic that pulls the data to run the
     * rule
     */
    public String getData();

    /**
     * Returns the logic that is applied to the data to decide what action
     * should be taken
     *
     * @return String the logic that is applied to the data to decide what
     ...
     *
     * @return String action that should be taken when the logic evaluates to
     * true
     */
