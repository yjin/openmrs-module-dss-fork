...
public class DssRmiServiceImpl implements DssRmiService {
    ...
    /**
     * @see
     * org.openmrs.module.dss.service.DssRmiService#runRule(java.lang.String,
     ...
     * @return Integer containing the location ID or null if a location is not
     * found matching the provided location name.
     */
