...
public class DssRuleProvider extends AbstractRuleProvider {
    ...
    /**
     * @see
     * org.openmrs.logic.rule.provider.RuleProvider#getRule(java.lang.String)
     */
    @Override
    ...
    /**
     * Returns the token name based on the configuration. Currently, the DSS
     * rule configurations are the class name complete with full package prefix.
     *
     * @param configuration The class name with the full package prefix.
     * @return The token name (which is the class name without the package
     * prefix.
     */
